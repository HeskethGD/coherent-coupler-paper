...
The code used in this paper is available at \cite{GeneralHeskethGDCoherentcouplerpaper} and includes Python Jupyter notebooks with symbolic derivations using \emph{SymPy} \cite{meurerSymPySymbolicComputing2017} as well as the code for numerical validation used in Section~\ref{sec:num-val}.
